...
Source0  : https://files.pythonhosted.org/packages/60/f0/dd2eb7911f948bf529f58f0c7931f6f6466f711bd6f1d81a69dc4edd4e2a/Pillow-8.1.2.tar.gz
...
%prep
%setup -q -n Pillow-8.1.2
cd %{_builddir}/Pillow-8.1.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615219378
...
cp %{_builddir}/Pillow-8.1.2/LICENSE %{buildroot}/usr/share/package-licenses/Pillow/efa73e04a33de84f89c1f957fa8dd8adbddd5949
cp %{_builddir}/Pillow-8.1.2/Tests/icc/LICENSE.txt %{buildroot}/usr/share/package-licenses/Pillow/371117588643c602bb8f15b280424e938c34c369
cp %{_builddir}/Pillow-8.1.2/docs/COPYING %{buildroot}/usr/share/package-licenses/Pillow/edd04741ed099f904917132d92f686c5e4a90095
